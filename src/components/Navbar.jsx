...
const Navbar = () => {
  ...
  return (
    <header className='sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 lg:px-2 '>
      <div className='max-w-7xl mx-auto flex h-14 items-center'>
        <div className='md:mr-4 flex justify-between w-full'>
          <a href="#" className='mr-6 flex items-center space-x-2 #F05454 text-lg font-medium'>
            @Sayam<span className='text-red-500'>Mahajan</span>
            </a>
        ...
        <button className='inline-flex items-center justify-center rounded-md md:hidden' onClick={handleMobileMenuClick}>
